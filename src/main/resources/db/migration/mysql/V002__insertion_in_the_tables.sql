...
VALUES (1, "Rafael Calearo", "1091507911", "rafaelcalearo@theevents.com", "12345", "-", "ADMIN", "0");
INSERT INTO usuario (id, nome, rg, email, senha, foto, tipo, ativo) 
VALUES (2, "Michel Luz", "1068475704", "michelluz@theevents.com", "54321", "-", "ADMIN", "0");
INSERT INTO usuario (id, nome, rg, email, senha, foto, tipo, ativo) 
VALUES (3, "Silvio Santos", "1000000105", "silvinho.santos@theevents.com", "silviorico", "-", "USER", "0");
